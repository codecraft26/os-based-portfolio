...
export default function Home() {
  ...
  const handleTerminalCommand = (cmd: string) => {
    ...
    if (command === '/help') {
      ...
      newHistory.push({ type: 'output', text: '🚀 Opening GitHub in new tab...' });
      window.open(linksData.social.github.url, '_blank');
    } else if (command === '/linkedin') {
      newHistory.push({ type: 'output', text: '💼 Opening LinkedIn in new tab...' });
      window.open(linksData.social.linkedin.url, '_blank');
    } else if (command === '/website') {
      newHistory.push({ type: 'output', text: '🌐 Opening website in new tab...' });
      window.open(linksData.social.website.url, '_blank');
    } else if (command === '/blog') {
      newHistory.push({ type: 'output', text: '✍️ Opening blog in new tab...' });
      window.open(linksData.social.blog.url, '_blank');
  ...
  return (
    <div className={`h-screen relative overflow-hidden transition-colors duration-700 ${isDarkMode
      ...
      <div className="h-full relative overflow-hidden">
        ...
        <div className="h-full relative p-8 overflow-hidden">
          ...
          <div className="absolute top-8 right-8 z-20 flex flex-col gap-3">
            ...
            <div className={`${isDarkMode
              ...
              <div className="relative w-32 h-32 mx-auto mb-3">
                {/* Clock face */}
                <div className={`absolute inset-0 rounded-full shadow-inner transition-colors duration-500 ${isDarkMode
                  ...
                  {[...Array(12)].map((_, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className={`absolute text-xs font-bold transition-colors duration-500 ${isDarkMode ? 'text-gray-200' : 'text-gray-700'
                          }`}
                        style={{
                          left: `${x}%`,
                          top: `${y}%`,
                  ...
                  {/* Center dot */}
                  <div className={`absolute top-1/2 left-1/2 w-3 h-3 rounded-full transform -translate-x-1/2 -translate-y-1/2 z-10 shadow-md transition-colors duration-500 ${isDarkMode ? 'bg-gray-200' : 'bg-gray-800'
                    }`}></div>

                  {/* Hour hand */}
                  <div
                    className={`absolute top-1/2 left-1/2 origin-bottom rounded-full shadow-md transition-colors duration-500 ${isDarkMode ? 'bg-gray-200' : 'bg-gray-800'
                      }`}
                    style={{
                      width: '4px',
                      height: '35px',
                      transform: `translate(-50%, -100%) rotate(${(currentTime.getHours() % 12) * 30 + currentTime.getMinutes() * 0.5
                        }deg)`,
                  ...
                  {/* Minute hand */}
                  <div
                    className={`absolute top-1/2 left-1/2 origin-bottom rounded-full shadow-md transition-colors duration-500 ${isDarkMode ? 'bg-gray-300' : 'bg-gray-700'
                      }`}
                    style={{
                      width: '3px',
                      height: '45px',
                      transform: `translate(-50%, -100%) rotate(${currentTime.getMinutes() * 6 + currentTime.getSeconds() * 0.1
                        }deg)`,
                      transition: 'transform 0.5s cubic-bezier(0.4, 0, 0.2, 1)'
                    }}
                  ></div>
              ...
              <div className="text-center">
                <div className={`text-sm font-semibold transition-colors duration-500 ${isDarkMode ? 'text-gray-200' : 'text-gray-800'
                  }`}>
                  {currentTime.toLocaleDateString('en-US', { weekday: 'short', month: 'short', day: 'numeric' })}
                </div>
                <div className={`text-xs font-mono transition-colors duration-500 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'
                  }`}>
            ...
            <div className={`${isDarkMode
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className={`font-medium transition-colors duration-500 ${isDarkMode ? 'text-gray-200' : 'text-gray-700'
          ...
          <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 fade-in">
            <div className="bg-white/80 backdrop-blur-md border-2 border-gray-300 rounded-xl p-2 shadow-2xl flex items-center gap-2">
              {/* Social Links */}
              <a
                href={linksData.social.github.url}
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-1"
                title="GitHub"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-1"
                title="LinkedIn"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-1"
                title="Website"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-1"
                title="Blog"
              >
              ...
              <button
                onClick={() => handleSectionChange('contact')}
                className="w-10 h-10 bg-gradient-to-br from-red-500 to-pink-500 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-1"
                title="Email"
              >
              ...
              {recentSections.slice(0, 3).map((section) => (
                <button
                  ...
                  className="w-10 h-10 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-1 border-2 border-gray-300"
              ...
              <button
                ...
                className="w-10 h-10 bg-gradient-to-br from-orange-400 to-orange-500 rounded-lg flex items-center justify-center hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-1 relative"
          ...
          {!isWindowOpen && (
            <div className="absolute bottom-32 right-12 pointer-events-none z-5">
              <div className="text-right">
                {/* Large Name */}
                <h1 className={`text-6xl font-bold mb-3 font-display bg-gradient-to-r bg-clip-text text-transparent drop-shadow-xl transition-all duration-500 ${isDarkMode
                ...
                {/* Designation */}
                <p className={`text-2xl font-semibold tracking-wide mb-1 transition-colors duration-500 ${isDarkMode ? 'text-gray-300/70' : 'text-gray-700/60'
                  }`}>
                  {linksData.personal.designation}
                </p>
                <p className={`text-lg transition-colors duration-500 ${isDarkMode ? 'text-gray-400/60' : 'text-gray-600/50'
                  }`}>
          ...
          >
            <div className={`backdrop-blur-md border-2 rounded-xl p-4 shadow-lg transition-colors duration-500 relative ${isDarkMode
            ...
            {/* Desktop Info */}
            <div className={`mt-3 text-xs backdrop-blur-sm px-3 py-2 rounded-lg shadow-sm transition-colors duration-500 ${isDarkMode
          ...
          <div className={`${isMaximized
            ...
            {isWindowOpen && (
              <div
                className={`shadow-2xl border-2 overflow-hidden window-enter transition-colors duration-500 relative ${isMaximized
              ...
              >
                ...
                {/* Window Title Bar */}
                <div
                  className={`border-b-2 px-4 py-3 flex items-center justify-between transition-colors duration-500 ${isDarkMode
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className={`text-sm font-semibold flex items-center gap-2 transition-colors duration-500 ${isDarkMode ? 'text-gray-200' : 'text-gray-900'
                      }`}>
                ...
                {/* Document Content */}
                <div className={`overflow-y-auto transition-colors duration-500 ${activeSection === 'terminal'
                  ? 'p-0 bg-black'
                    ...
                    <div className="h-full flex flex-col bg-black p-0">
                      <div className="flex-1 overflow-y-auto p-6 font-mono text-sm space-y-1">
                        {terminalHistory.map((entry, idx) => (
                          <div key={idx} className={`${entry.type === 'input' ? 'text-cyan-400' :
          ...
          {isBrowserOpen && (
            ...
            >
              <div className={`h-full flex flex-col shadow-2xl border-2 rounded-lg overflow-hidden transition-colors duration-500 ${isDarkMode
                ? 'bg-gray-800 border-gray-600'
                : 'bg-white border-gray-300'
                }`}>
                {/* Browser Title Bar */}
                <div
                  className={`px-4 py-3 flex items-center justify-between border-b-2 transition-colors duration-500 ${isDarkMode
                    ? 'bg-gradient-to-b from-gray-700 to-gray-800 border-gray-600'
                    : 'bg-gradient-to-b from-[#E8DCC4] to-[#D4C5A9] border-gray-300'
                    }`}
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`text-sm font-semibold transition-colors duration-500 ${isDarkMode ? 'text-gray-200' : 'text-gray-900'
                      }`}>
                      Browser
                    </span>
                  </div>
                ...
                {/* Browser Controls */}
                <div className={`px-4 py-3 flex items-center gap-3 border-b transition-colors duration-500 ${isDarkMode
                  ...
                  <button
                    ...
                    className={`p-2 rounded-lg hover:bg-gray-200 transition ${isDarkMode ? 'hover:bg-gray-600' : 'hover:bg-gray-200'
                      }`}
                    title="Back"
                  >
                  ...
                  <button
                    ...
                    className={`p-2 rounded-lg transition ${isDarkMode ? 'hover:bg-gray-600' : 'hover:bg-gray-200'
                      }`}
                    title="Refresh"
                  >
                  ...
                  <div className={`flex-1 flex items-center gap-2 px-4 py-2 rounded-lg transition-colors duration-500 ${isDarkMode
                    ...
                    <input
                      ...
                      className={`flex-1 bg-transparent outline-none text-sm ${isDarkMode ? 'text-gray-200' : 'text-gray-900'
                        }`}
                      ...
                      {!iframeError ? (
                        ...
                        <div className="w-full h-full flex flex-col items-center justify-center p-8 text-center">
                          ...
                          <div className="flex flex-col gap-3 w-full max-w-md">
                            ...
                            {/* Quick Info Card */}
                            <div className={`p-6 rounded-xl border-2 text-left ${isDarkMode
                              ? 'bg-gray-800 border-gray-600'
                              : 'bg-gray-50 border-gray-300'
                              }`}>
                            ...
                            <button
                              ...
                              className={`px-6 py-3 rounded-lg font-medium transition ${isDarkMode
                      ...
                      <div className="text-center max-w-2xl px-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <button
                            ...
                            className={`p-4 rounded-xl border-2 hover:shadow-lg transition ${isDarkMode
